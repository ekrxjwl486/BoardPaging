...
public class PdsPagingVo {
	...
	private int prenowpage; //이전 10개를 클릭시 적용되는 nowpage
	...
	public boolean isIsshowpagepre() {
		return isshowpagepre;
	}
	public void setIsshowpagepre(boolean isshowpagepre) {
		this.isshowpagepre = isshowpagepre;
	}
